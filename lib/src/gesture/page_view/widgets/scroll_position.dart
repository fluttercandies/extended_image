...
class ExtendedScrollPositionWithSingleContext extends ScrollPosition
  ...
  bool get hasViewportDimension => viewportDimension != null;
  ...
  void absorb(ScrollPosition other) {
    ...
    final ExtendedScrollPositionWithSingleContext otherOne =
        other as ExtendedScrollPositionWithSingleContext;
    activity.updateDelegate(this);
    _userScrollDirection = otherOne._userScrollDirection;
    assert(_currentDrag == null);
    if (otherOne._currentDrag != null) {
      _currentDrag = otherOne._currentDrag;
      _currentDrag.updateDelegate(this);
      otherOne._currentDrag = null;
    }
  }
