...
class ExtendedImageGestureState extends State<ExtendedImageGesture>
  ...
  void handleScaleUpdate(ScaleUpdateDetails details1) {
    ///whether gesture page
    if (details1 is! ExtendedScaleUpdateDetails) {
      return;
    }
    final ExtendedScaleUpdateDetails details =
        details1 as ExtendedScaleUpdateDetails;
    if (extendedImageSlidePageState != null &&
        details.scale == 1.0 &&
